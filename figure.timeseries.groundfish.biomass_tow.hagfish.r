figure.timeseries.groundfish.biomass_tow.hagfish = function() {
  ...
  p1 <- ggplot(x, aes(x = year)) +
    ...
    labs( x = "Year", y = "Biomass (Kg/tow)") +
    scale_linetype_manual(name = "Legend", labels = c("Mean kg/tow", "Median 1983:2017"), values = c("solid", "longdash")) +
    scale_colour_manual(name = "Legend", labels = c("Mean kg/tow", "Median 1983:2017"), values = c("grey0", "forestgreen")) +
