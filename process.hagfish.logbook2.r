process.hagfish.logbook2 = function(){
  
p = setup.parameters()
l = hagfish.logbook.db(DS="logbook")
h.z <- load.shapefile(DS = 'hagfish.z')
l = intersect.sp(l, h.z, var = 'zoner')
...
s = l[which(l$yr >= '2014' & (l$zones == 'gully'| l$zones == 'slope'| l$zones == '4vn_slope') & is.finite(l$cpue)), 19 ]
l[which(l$yr >= '2014'& (l$zones == 'gully'| l$zones == 'slope'| l$zones == '4vn_slope') & is.finite(l$cpue)), 19] <- s + 12.5

s = l[which(l$yr >= '2014' & (l$zones == 'mid-shore' | l$zones == 'jordan' | l$zones == 'ne_channel' | l$zones == 'georges_basin'| 
                                l$zones == '4vn'| l$zones == 'other') & is.finite(l$cpue)), 19 ]
l[which(l$yr >= '2014'& (l$zones == 'mid-Shore' | l$zones == 'jordan' | l$zones == 'ne_channel' | l$zones == 'georges_basin'| 
